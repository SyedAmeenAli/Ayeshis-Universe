...
export const WRECK_REACTIONS = {
  ...
  heavy: [
    ...
    "Not the balls again!",
    "The potty council made you do this.",
    "I have one HP left!",
    "This is maximum potty behaviour.",
    "My dignity has entered the toilet.",
    "That attack was medically unnecessary.",
  ],
  scribble: [
    ...
    "Why are you turning me into a potty?",
    "Do not write PUNGUN on my forehead.",
    "I have officially become a Pungun.",
  ],
  ko: [
