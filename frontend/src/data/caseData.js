...
export const PHONE_MESSAGES = [
  ...
  },
  {
    thread: "sarah",
    contact: "Sarah",
    preview: "hey, is everything okay?",
    messages: [
      { from: "them", text: "hey, is everything okay?", ts: "20:12" },
      { from: "me", text: "why", ts: "20:13" },
      { from: "them", text: "no reason", ts: "20:13" },
...
export const PHONE_CONTACTS = [
  ...
  { key: "sarah", label: "Sarah", subtitle: "Concerning", pinnable: true },
...
export const PHONE_NOTES = [
  ...
  { key: "n4", title: "reminders.txt", body: "Do not forget the wasabi. Do not forget Ayesha's charger. Do not forget your dignity, wherever it is." },
...
export const PHONE_FILES = [
  ...
  { key: "sarah-alibi", name: "SARAH_ALIBI.enc", type: "encrypted", locked: true },
...
export const ACT_I = {
  ...
  puzzles: [
    ...
    {
      key: "sarah",
      title: "Sarah Red Herring",
      prompt: "SARAH_ALIBI.enc — password required.",
      hints: [
        "Enter the stupidest insult that somehow became part of your relationship vocabulary.",
        "A five-letter word with absolutely no intellectual value.",
        "It belongs in a toilet and apparently also in your conversations.",
      ],
      answer_target: "potty",
      kind: "password",
      followUp: {
        ...
        contradictions: [
          { key: "ts", label: "Image metadata claims it was captured at 10:31 PM." },
          { key: "clock", label: "Visible clock in the image shows 9:48 PM." },
          { key: "location", label: "The location certificate was generated after the alleged photograph." },
          { key: "author", label: "Image encoder is listed as ARCHIVIST_RENDER_NODE." },
          { key: "login", label: "Sarah's login occurred from two locations within an impossible interval." },
          { key: "token", label: "The access token used after 10:00 PM was already expired." },
          { key: "gps", label: "A Cravery location field was inserted manually." },
        ],
        options: [
          { id: "framed", label: "Sarah's evidence was manipulated" },
          { id: "guilty", label: "Sarah is responsible" },
  ...
  puzzles: [
    ...
    },
    {
      ...
      packets: [
        ...
        { id: 4, src: "SARAH_PHONE", status: "failed", proto: "sms", payload: "" },
      ],
  ...
  puzzles: [
    ...
    },
    {
      ...
      cards: [
        ...
        { id: "sarah", label: "Sarah alibi", correct: "manipulated" },
